...
namespace JobApplication.API.Controllers
{
    ...
    public class JobCandidateApplicationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Apply([FromForm] CreateJobCandidateApplicationDto createApplicationDto, [FromForm] IFormFile cv)
        {
            ...
            try
            {
                var result = await _mediator.Send(new ApplyCommand(UserId, createApplicationDto.JobId, stream, extension));
