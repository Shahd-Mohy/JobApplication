...
{
    public class ApplyCommandHandler : IRequestHandler<ApplyCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(ApplyCommand request, CancellationToken cancellationToken)
        {
